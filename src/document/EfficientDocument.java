...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		for(String s: tokens)
		{
			...
			{
				numWords++;
				int temp = countSyllables(s);
				//System.out.println("Adding " + temp + " for word " + s);
...
//		System.out.println("Syllables: " + numSyllables);
		...
		{
			//System.out.println("Last added: " + last);
			numSentences++;
		}
	}
...
//		EfficientDocument temp = new EfficientDocument("Sentences?!");
	}
