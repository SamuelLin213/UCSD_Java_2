...
//		List<String> tokens = getTokens("[aeiouyAEIOUY]+"); // get total number of consecutive vowels, including y's
//		List<String> loneEs = getTokens("[^aeiouyAEIOUY]+[eE]\\b"); // get number of lone e's at the end of word
//		List<String> singleEs = getTokens("\\b[^aeiouyAEIOUY]*[eE]\\b"); // account for single syllable e's
//		
//		
